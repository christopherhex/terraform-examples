...
resource "aws_cloudfront_distribution" "s3_distribution" {
  ...
  // If we host on S3 an 403 error code will be thrown when we navigate to a page that does not exist (in S3 file tree)
  // This error catching makes sure that all URL's pass the SPA app
